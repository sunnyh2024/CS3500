...
/**
 * Tests for the MultiLayerEditorModel class and all dependencies: tests to ensure that
 * MultiLayerEditorModel and all methods inside work correctly.
 */
public class MultiLayerEditorModelTest {
  ...
  public void testConstructModelNullImage() {
    IMultiLayerEditorModel model = new MultiLayerEditorModel(img2, null, img3);
  }

  // Tests constructing a model with images of different sizes
  @Test(expected = IllegalArgumentException.class)
  public void testConstructModelDifferentSizes() {
    IMultiLayerEditorModel model = new MultiLayerEditorModel(img2, img1, img3);
  }

  // Tests constructing a model with a non-rectangular image
  @Test(expected = IllegalArgumentException.class)
  public void testConstructModelNonRectangularImage() {
    IMultiLayerEditorModel model = new MultiLayerEditorModel(img1, this.nonRectImg);
  }
  ...
  public void testGetAllImagesModelOneImage() {
    IMultiLayerEditorModel model = new MultiLayerEditorModel(img2);
  ...
  public void testGetAllImagesModelMultipleImages() {
    IMultiLayerEditorModel model = new MultiLayerEditorModel(img2, img3);
    assertArrayEquals(img2, model.getAllImages().get(0));
  ...
  public void testGetTopMostImageAllInvisible() {
    IMultiLayerEditorModel model = new MultiLayerEditorModel(img2, img3, img2);
  ...
  public void testBlurValidIndex() {
    ...
    IMultiLayerEditorModel model = new MultiLayerEditorModel(otherImg, img, img);
    model.blur(2);
  ...
  public void testSharpenValidIndex() {
    ...
    IMultiLayerEditorModel model = new MultiLayerEditorModel(otherImg, otherImg, img);
    model.sharpen(2);
    IPixel[][] finalImage = model.getSingleImage(2);
  ...
  public void testAddImageBadIndex() {
    ...
    IMultiLayerEditorModel model = new MultiLayerEditorModel(img, img);
  ...
  public void testAddImageToTop() {
    ...
    IMultiLayerEditorModel model = new MultiLayerEditorModel(placeHolder, placeHolder);
  ...
  public void testRemoveImageTop() {
    ...
    IMultiLayerEditorModel model = new MultiLayerEditorModel(img, placeHolder, img);
    model.removeImage(2);
