 ...
 * game. This version of the game will only be able to handle single-card moves. Updates the state
 * of the game using inputs given by the controller to play a game of Freecell.
 */
public class SimpleFreecellModel implements FreecellModel<ICard> {

  // changed fields from private to protected so MultiFreecellModel can inherit.
  protected final ArrayList<IPile<ICard>> openPiles;
  protected final ArrayList<IPile<ICard>> foundationPiles;
  protected final ArrayList<IPile<ICard>> cascadePiles;
