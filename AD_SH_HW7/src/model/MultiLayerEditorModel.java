...
public class MultiLayerEditorModel implements IMultiLayerEditorModel {
  ...
  // changed from private to protected so subclasses can use these fields.
  protected final ArrayList<ImageEditorModel> imageModels;
  protected final ArrayList<Boolean> visibilityIdentifiers;
  ...
  // Changed from private to protected so subclasses can have access to this method
  /**
